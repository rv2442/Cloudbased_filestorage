<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="CloudStorage.WebForm2" %>
...
<body>
        ...
        function AcccessCodeBehindValue() {
            ...
            var dwn = document.getElementById('<%=HiddenField3.ClientID%>').value;
  ...
  <div class="email">
    ...
    <div class="sec-2">
      <ion-icon name="person-circle-outline"></ion-icon>
       ...
       <asp:TextBox ID="txtusername" runat="server"  placeholder="Enter Username" Height="20px" Width="445px"></asp:TextBox>
    ...
    <div class="sec-2">
     <ion-icon name="mail-outline"></ion-icon>
       ...
       <asp:TextBox ID="txtemail" runat="server" placeholder="User@gmail.com" Width="444px" CssClass="auto-style1" Height="23px" TextMode="Email"></asp:TextBox>
