<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginCSS.aspx.cs" Inherits="LoginPass.WebForm11" %>
<!DOCTYPE html>
<html lang="en" >
<head>
  <meta charset="UTF-8">
...
<%--  <svg class="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="300" height="300" viewbox="0 0 640 480" xml:space="preserve">
  ...
  <div><asp:Label ID="lblmsg" runat="server" Text="Incorrect Username or password" Visible="False"></asp:Label></div>
    <asp:Button ID="Button3" class="login" runat="server" OnClick="Button1_Click" Text="Login" />
  <div class="footer"> 
