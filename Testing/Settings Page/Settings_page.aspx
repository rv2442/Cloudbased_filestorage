    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="Blue" BorderWidth="30px" ForeColor="Black" style="z-index: 1;border-radius: 45px; left: 612px; top: 54px; position: absolute; height: 864px; width: 936px">
            <asp:Panel ID="Panel2" runat="server" BackColor="#99CCFF" style="z-index: 1; left: -616px; top: -29px; position: absolute; border-radius: 35px; height: 923px; width: 559px">
                <div id="myProgress" style="position:absolute; border-radius: 5px; top: 531px; left: 47px;">
                ...
                <asp:Image ID="Image4" runat="server" ImageUrl="~/premium icon.png" style="z-index: 1; left: 179px; top: 773px; position: absolute;border-radius: 25px; height: 24px; width: 40px" />
            </asp:Panel>
            ...
            <asp:Label ID="displayusernametxt" runat="server" style="z-index: 1; left: -418px; top: 410px; position: absolute; height: 55px; width: 148px"></asp:Label>
            ...
            <asp:Button ID="enable_auth" runat="server" style="z-index: 1; left: 290px; top: 550px; position: absolute; height: 39px; width: 184px" Text="Enable Face Auth" OnClick="enable_auth_Click" />
            <asp:Button ID="disable_button" runat="server" OnClick="disable_button_Click" style="z-index: 1; left: 291px; top: 551px; position: absolute; height: 39px; width: 184px" Text="Disable Face Auth" />
        </asp:Panel>
