  ...
  <div class="email">
    ...
    <div class="sec-2">
     <ion-icon name="mail-outline"></ion-icon>
       ...
       <asp:TextBox ID="txtemail" runat="server" AutoPostBack="True"  OnTextChanged="txtemail_TextChanged" placeholder="User@gmail.com" Width="444px"  Height="23px" TextMode="Email"></asp:TextBox>
