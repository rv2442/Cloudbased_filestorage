    ...
    <div class="dropdown-content">
     ...
     <a href="javascript:if(confirm('Are you sure you want to log out?')) window.location.href = 'Login.aspx';">Sign Out</a>
      ...
      <div style="background-color:#000091; margin-top: 0px" class="auto-style1">  
          &nbsp <asp:Button ID="Share_access" runat="server" OnClick="New_folder_Click" Text="Share Acess" />&nbsp &nbsp
        <asp:ScriptManager ID="ScriptManager1" runat="server" >
           ...
           <asp:Button ID="Back" runat="server"  OnClick="Back_Click" Text="Back" Height="28px" Width="50px" /> &nbsp 
      </div> 
